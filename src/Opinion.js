...
import OpinionFetchData from "./OpinionFetchData";
  ...
  return (
    <div className="editorialmain">
      <div className="editorialdisplay">
        <h2 style={{marginLeft:"50px",marginBottom:"30px"}}>Opinion Data</h2>
        {list.map((links) => {
          const { title, description, id, date } = links;
          return (
           <OpinionFetchData title={title} description={description} id={id} date={date} />
          )
        })}
      </div>
