...
import PunjabiFetchData from "./PunjabiFetchData";
  ...
  return (
    <div className="editorialmain">
      <div className="editorialdisplay">
        <h2 style={{marginLeft:"80px",marginBottom:"30px"}}>Punjabi</h2>
        {list.map((links) => {
          const { title, description, id, date } = links;
          return (
           <PunjabiFetchData title={title} description={description} id={id} date={date} />
