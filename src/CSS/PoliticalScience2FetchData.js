...
function PoliticalScience2FetchData({id,date,description,title}) {
...
<Button onClick={updateTodo} color="secondary" variant="outlined" style={{marginTop:"10px"}}>Update Todo</Button>
        ...
        {/* <h1>333333333333333</h1> */}
            ...
            <article className="question" key={id}>
              ...
              <button className="mybtn"  style={{margin:"5px"}} onClick={(e) => db.collection("politicalscienceII").doc(id).delete()}>
              <HighlightOffIcon/>
             </button>
...
export default PoliticalScience2FetchData
