...
import PakAffairsFetchData from "./PakAffairsFetchData";
import { makeStyles 
  ...
  return (
    <div className="editorialmain">
      <div className="editorialdisplay">
        <h2 style={{marginLeft:"50px",marginBottom:"30px"}}>PAK AFFAIRS</h2>
        {list.map((links) => {
          const { title, description, id, date } = links;
          return (
           <PakAffairsFetchData title={title} description={description} id={id} date={date} />
