...
import EssayFetchData from "./EssayFetchData";
  ...
  return (
    <div className="editorialmain">
      <div className="editorialdisplay">
        <h2 style={{marginLeft:"50px",marginBottom:"30px"}}>ESSAY</h2>
        {list.map((links) => {
          const { title, description, id, date } = links;
          return (
           <EssayFetchData title={title} description={description} id={id} date={date} />
