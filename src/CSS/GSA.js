...
import GSAFetchData from "./GSAFetchData";
import { makeStyles 
  ...
  return (
    <div className="editorialmain">
      <div className="editorialdisplay">
        <h2 style={{marginLeft:"50px",marginBottom:"30px"}}>GSA</h2>
        {list.map((links) => {
          const { title, description, id, date } = links;
          return (
           <GSAFetchData title={title} description={description} id={id} date={date} />
