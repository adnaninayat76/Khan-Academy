...
import USFetchData from "./USFetchData";
  ...
  return (
    <div className="editorialmain">
      <div className="editorialdisplay">
        <h2 style={{marginLeft:"50px",marginBottom:"30px"}}>US HISTORY</h2>
        {list.map((links) => {
          const { title, description, id, date } = links;
          return (
           <USFetchData title={title} description={description} id={id} date={date} />
