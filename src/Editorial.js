...
import EditorialFetchData from "./EditorialFetchData";
  ...
  return (
    <div className="editorialmain">
      <div className="editorialdisplay">
        <h2 style={{marginLeft:"50px",marginBottom:"30px"}}>Editorial Data</h2>
        {list.map((links) => {
          const { title, description, id, date } = links;
          return (
           <EditorialFetchData title={title} description={description} id={id} date={date} />
